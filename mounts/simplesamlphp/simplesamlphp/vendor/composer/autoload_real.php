...
class ComposerAutoloaderInitd08dde05108a349527e2b34053dadfcf
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitd08dde05108a349527e2b34053dadfcf::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequired08dde05108a349527e2b34053dadfcf($fileIdentifier, $file);
        }
...
function composerRequired08dde05108a349527e2b34053dadfcf($fileIdentifier, $file)
{
