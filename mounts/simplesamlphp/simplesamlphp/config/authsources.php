...
$config = [
    ...
    'database-sql' => [
        'sqlauth:SQL',
        'dsn' => 'pgsql:host=simplesamlphp-database;port=5432;dbname=simplesamlphp',
        'username' => 'simplesamlphp',
        'password' => 'hcYusUTtmbQEuAdDangQJXYXHD4pyurz',
        'query' => "SELECT uid, givenName, email, eduPersonPrincipalName FROM sessions WHERE eduPersonPrincipalName=:username AND uid=:password"
